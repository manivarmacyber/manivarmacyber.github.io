...
export {
  ...
  eachAxis as I,
  measurePageBox as J,
  convertBoxToBoundingBox as K,
  convertBoundingBoxToBox as L,
  addValueToWillChange as M,
  animateMotionValue as N,
  setDragLock as O,
  resize as P,
  percent as Q,
  isElementTextInput as R,
  SVGVisualElement as S,
  noop as T,
  microtask as U,
  globalProjectionState as V,
  HTMLProjectionNode as W,
  hover as X,
  press as Y,
