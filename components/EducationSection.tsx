...
export const EducationSection: React.FC = () => {
    ...
    return (
        <div id="education" className="space-y-16 py-20">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-8 container-progressive">
                {education.map((item, i) => (
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-[10px] font-mono text-accent-secondary font-black uppercase tracking-[0.2em] group-hover:text-accent-secondary">
                                {item.degree}
                            </p>
                        </div>
