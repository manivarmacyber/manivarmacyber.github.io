...
import { Terminal, Shield, Cpu, MessageSquare, Briefcase, ShieldAlert, Sun, Moon, ChevronDown, Fingerprint } from 'lucide-react';
...
export const Navigation: React.FC<NavigationProps> = ({ activeSection, theme, themeMode, toggleTheme }) => {
  ...
  const NavItem = ({ item, isActive }: { item: any; isActive: boolean }) => {
    ...
    const props = isExternal 
      ...
      : { to: item.path, onClick: () => handleNavClick(item.id, item.path) };
