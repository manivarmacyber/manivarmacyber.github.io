        ...
        <div id="mission" className="py-20">
            <div className="container mx-auto px-6 max-w-6xl">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="p-12 md:p-16 border border-border-color relative overflow-hidden group rounded-[3rem]"
                ...
                >
                    ...
                    <div className="relative z-10 space-y-12">
                        <div className="space-y-4">
                            <span className="text-[10px] font-mono text-accent-primary uppercase tracking-[1em] font-black">SELF-DRIVEN MISSION</span>
                            <h2 className="text-3xl md:text-5xl font-orbitron font-black text-text-primary uppercase tracking-tighter leading-[1.1] italic">
                                SELF-DRIVEN CYBERSECURITY <span className="text-accent-primary">PROFESSIONAL</span> WITH A STRONG FOCUS ON <span className="text-text-primary underline decoration-accent-primary underline-offset-8">PENETRATION TESTING</span> AND BUG HUNTING.
                            </h2>
                        </div>
