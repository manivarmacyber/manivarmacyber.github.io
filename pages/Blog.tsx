                ...
                <Link to={`/blog/${post.slug}`} className="block h-full">
                  <div className="glass-card h-full flex flex-col overflow-hidden">
                    <div className="relative h-48 overflow-hidden">
                      ...
                      <div className="absolute bottom-4 left-4 flex gap-2">
                        {post.tags.slice(0, 2).map(tag => (
                          <span key={tag} className="text-[9px] font-orbitron font-bold bg-accent-cyan/10 text-accent-cyan px-3 py-1.5 rounded-2xl border border-accent-cyan/20 backdrop-blur-xl uppercase tracking-widest leading-none">
                            {tag}
                          </span>
                        ))}
                      </div>
                    ...
                    <div className="p-8 flex-grow flex flex-col">
                      ...
                      <div className="mt-auto flex items-center gap-3 text-accent-cyan font-orbitron font-black text-[10px] tracking-[0.4em] uppercase italic group-hover:gap-5 transition-all">
